...
func NewFSM_v2(ch chan struct{}) *fsm.FSM {
	...
	rfsm := fsm.NewFSM(
		...
		fsm.Events{
			...
			{Name: eS2_0, Src: []string{sWait}, Dst: sInput},
			...
			{Name: eS1_0, Src: []string{sAlarmInput, sAlarmOutput}, Dst: sAlarmExit},
			{Name: eS2_0, Src: []string{sAlarmInput, sAlarmOutput}, Dst: sAlarmExit},
